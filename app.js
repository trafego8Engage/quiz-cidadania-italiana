...
const CONCLUSIONS = {
  alta:{
    ...
    ctaButtonLabel:'Ver os próximos passos do meu caso',
  ...
  media:{
    ...
    ctaButtonLabel:'Ver o que falta esclarecer no meu caso',
  ...
  baixa:{
    ...
    ctaButtonLabel:'Ver por onde posso começar',
...
function showConclusion(total,priorityName,grade){
  ...
  $('conclusionCtaButtonTop').textContent = 'Ver meu resultado completo';
